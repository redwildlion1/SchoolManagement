    ...
    <div style="width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
            <div class="col-md-8">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Name sould be in Characters"
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
            ...
            <div class="col-md-8">
                ...
                <asp:TextBox ID="txtMobile" runat="server" CssClass="form-control" TextMode="Number" placeholder="10 Digit Mobile No.">
                </asp:TextBox>
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
            <div class="col-md-8">
                ...
                <asp:TextBox ID="txtAdress" runat="server" CssClass="form-control" placeholder="Enter Adress" required="True" TextMode="MultiLine"></asp:TextBox>
            </div>
        </div>
